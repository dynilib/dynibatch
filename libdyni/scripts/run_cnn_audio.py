...
from libdyni.utils.neuralnet import build_cnn_audio, train_cnn
...
def run(audio_root,
    ...
    ac_ext = AudioChunkExtractor(audio_root, sample_rate)
    ...
    # build network
    input_var, target_var, network = build_cnn_audio(batch_size,
            num_time_bins,
            len(classes))
