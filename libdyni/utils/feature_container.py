...
class FeatureContainer:
    ...
    def has_features(self, features):
        """Check whether the feature container has a set of features with a given config.   
        Args:
    ...
    def load(path):
        try:
            ...
            if not isinstance(fc, FeatureContainer):
                raise Exception("Object in {} is not an instance of FeatureContainer".format(path))
            return fc
